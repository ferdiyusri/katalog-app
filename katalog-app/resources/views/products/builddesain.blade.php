...
@section('title', 'Build dan Desain')
...
@section('content')
    ...
    <section class="page-header">
        ...
        <div class="container position-relative">
            <div class="page-header-label">Koleksi Build dan Desain</div>
            <h1 class="page-header-title">Build dan Desain</h1>
            <p class="page-header-desc">Temukan material bangunan, struktur, dan semua kebutuhan konstruksi berkualitas tinggi untuk proyek Anda.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="filter-tabs">
                    ...
                    <a href="{{ route('products.interior') }}" class="filter-tab">Interior</a>
                    <a href="{{ route('products.builddesain') }}" class="filter-tab active">Build dan Desain</a>
                </div>
            ...
            <div class="row g-4 fade-up" id="productGrid">
                ...
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <h3>Belum Ada Produk Build dan Desain</h3>
                        <p>Produk build &amp; desain belum tersedia. Silakan tambahkan melalui panel admin.</p>
                    </div>
                </div>
                @endforelse
            </div>
